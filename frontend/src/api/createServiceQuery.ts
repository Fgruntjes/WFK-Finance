import type { CreateQueryOptions, CreateQueryResult, QueryFunctionContext, QueryKey } from '@tanstack/svelte-query';
...
>(
    ...
    queryOptions: 
        Omit<Omit<CreateQueryOptions<TQueryFnData, Error, TData, TQueryKey>, 'initialData'>, 'queryFn'>
        & {
