...
export const InstitutionConnectionCreate = () => {
            ...
            <Box h={"100%"} maw={300} mx="auto">
                <form>
                    <CountrySelect
                        ...
                        label={t("pages.institutionconnection.create.country-label", "Country")}
                        {...getInputProps("country")} />

                    <InstitutionSelect country={country || undefined}
                                       label={t("pages.institutionconnection.create.institution-label", "Institution")}
